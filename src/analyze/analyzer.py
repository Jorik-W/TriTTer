...
class CDAAnalyzer:
    ...
    def _calculate_air_density(weather_data):
        ...
        return (pressure * 100.0) / (287.058 * temp_kelvin)
    ...
    def _calculate_rolling_power(self, speeds, slopes=None):
        ...
        if slopes is None:
            slopes = 0.0
        return (self._total_mass * 9.80665 * 
    ...
    def _calculate_estimated_power(self, segment_df, fixed_cda, weather_data=None):
        ...
        rolling_force = self._total_mass * 9.80665 * self.parameters['rolling_resistance'] * np.cos(np.radians(slopes))
        gradient_force = self._total_mass * 9.80665 * np.sin(np.radians(slopes))
