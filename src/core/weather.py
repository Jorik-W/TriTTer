...
class WeatherService:
    ...
    def calculate_air_density(self, temperature, pressure, humidity=50):
        ...
        # Use the shared, humidity-corrected air-density model so that the
        # Analyze (CdA) and Plan (pacing) sides agree on air density.
        return air_density(temperature, pressure, humidity)