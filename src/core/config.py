...
DEFAULT_PARAMETERS = {
    ...
    'max_slope_variation': 15.0,  # degrees
    'min_speed': 5.0,     # m/s
    'max_speed': 20.0,    # m/s
    ...
    'cda_keep_percent': 90.0,       # iteratively remove largest abs CdA outliers until x% remains
    ...
    'elevation_source': 'fit_only',  # 'open_elevation', 'open_meteo', or 'fit_only'
